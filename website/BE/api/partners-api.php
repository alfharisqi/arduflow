...
function partnersDatabasePath(): array
{
...
function partnersPdo(): PDO
{
    [$databasePath, $busyTimeout] = partnersDatabasePath();
    ...
    try {
        ...
        error_log('Koneksi SQLite partner gagal: ' . $exception->getMessage());

        afwSendJson(500, false, 'Koneksi database partner gagal.', [
