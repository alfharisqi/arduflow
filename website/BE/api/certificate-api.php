...
try {
    ...
    if (
        ...
        $pdo->exec(
            'ALTER TABLE certificates
             ADD COLUMN member_key TEXT NULL'
        );
    }
    ...
    /*
     * Index penting untuk endpoint pencarian.
     */

    $pdo->exec(
        'CREATE INDEX IF NOT EXISTS
         idx_certificates_registration
         ON certificates(registration_id)'
    );

    $pdo->exec(
        'CREATE INDEX IF NOT EXISTS
         idx_certificates_registration_member
         ON certificates(
             registration_id,
             workshop_id,
             member_key
    ...
    $pdo->exec(
        'CREATE INDEX IF NOT EXISTS
         idx_certificates_email
         ON certificates(email)'
    );
    ...
    $pdo->exec(
        'CREATE INDEX IF NOT EXISTS
         idx_certificates_workshop
         ON certificates(workshop_id)'
    );
