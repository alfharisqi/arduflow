...
function ensureProjectTables(
    ...
    $indexes = [
        ...
        'idx_user_entitlements_product'
            => 'CREATE INDEX idx_user_entitlements_product ON user_entitlements(product_type, product_id)',
    ];
